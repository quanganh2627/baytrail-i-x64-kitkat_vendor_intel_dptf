...
void PerformanceControlFacade::initializeControlsIfNeeded()
{
    if (supportsPerformanceControls())
    {
        m_policyServices.messageLogging->writeMessageDebug(PolicyMessage(FLF, "Performance control initialization started."));
        ...
        m_policyServices.messageLogging->writeMessageDebug(PolicyMessage(FLF, "Performance control initialization finished."));
    }
}